...
! Quantities required for MW cloudy radiance calculations
  ...
  if ( icmask .and. n_clouds_fwd_wk > 0 .and. imp_physics==11 .and. lprecip_wk) then
     if (mype==0) write(6,*) myname_, 'calculate GFDL effective radius: calc_gfdl_reff'      
     do ii = 1, n_clouds_fwd_wk
        iii=jcloud(ii)
  ...
  if ( icmask .and. n_clouds_fwd_wk > 0 .and. imp_physics==08 .and. lprecip_wk) then
     if (mype==0) write(6,*) myname_, 'calculate Thompson effective radius: calc_thompson_reff'      
     do ii = 1, n_clouds_fwd_wk
        iii=jcloud(ii)
...
! if ( icmask .and. n_clouds_fwd_wk > 0 .and. imp_physics==11 .and.  lcalc_gfdl_cfrac ) then
  if ( icmask .and. n_clouds_fwd_wk > 0 .and. imp_physics==11 .and.  lprecip_wk ) then
     if (mype==0) write(6,*) myname_, 'calculate GFDL cloud fraction: calc_gfdl_cloudfrac'      
     cf_calc  = zero
  ...
  if ( icmask .and. n_clouds_fwd_wk > 0 .and. imp_physics==08 .and.  lprecip_wk ) then
     if (mype==0) write(6,*) myname_, 'calculate Thompson cloud fraction: calc_thompson_cloudfrac'      
     cf_calc  = zero
