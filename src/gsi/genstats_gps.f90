...
! Observation class
  character(7),parameter     :: obsclass = '    gps'
           ...
           call nc_diag_metadata_to_single("impact_parameter",                           gps_allptr%rdiag(26)) 
           call nc_diag_metadata_to_single("pccf",                                       gps_allptr%rdiag(27)) 
           call nc_diag_metadata_to_single("reference_sat_id",                           gps_allptr%rdiag(28)) 
           call nc_diag_metadata_to_single("earth_radius_of_curvature",                  gps_allptr%rdiag(29)) 
           call nc_diag_metadata_to_single("geoid_height_above_reference_ellipsoid",     gps_allptr%rdiag(30)) 
           call nc_diag_metadata_to_single("qfro",                                       gps_allptr%rdiag(31)) 
           call nc_diag_metadata_to_single("ascending_flag",                             gps_allptr%rdiag(32)) 
           call nc_diag_metadata_to_single("sensor_azimuth_angle",                       gps_allptr%rdiag(33)) 
           call nc_diag_metadata_to_single("sat_constellation",                          gps_allptr%rdiag(34)) 
           call nc_diag_metadata_to_single("occulting_sat",                              gps_allptr%rdiag(35)) 
           call nc_diag_metadata_to_single("process_center",                             gps_allptr%rdiag(36)) 
           call nc_diag_metadata_to_single("atmospheric_refractivity",                   gps_allptr%rdiag(37)) 
! xuanli output the altitude as height
           call nc_diag_metadata_to_single("Height",                                     gps_allptr%rdiag(38)) 
