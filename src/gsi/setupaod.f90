...
! Declare local arrays
  ...
  real(r_kind) :: clw_guess, tzbgr, sfc_speed,ciw_guess,rain_guess,snow_guess,graupel_guess
...
!       Interpolate model fields to observation location, call crtm and create jacobians
        call call_crtm(obstype,dtime,data_s(:,n),nchanl,nreal,ich, &
             tvp,qvp,qsat,clw_guess,ciw_guess,rain_guess,snow_guess,graupel_guess,prsltmp,prsitmp, &
