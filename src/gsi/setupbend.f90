...
!> xuanli
     rdiagbuf(26,i)         = tpdpres(i)        ! impact parameter in meters
     rdiagbuf(27,i)         = data(ipctc,i)     ! input bufr qc - index of per cent confidence
     rdiagbuf(28,i)         = data(iptid,i)     ! transmitter occ id    
     rdiagbuf(29,i)         = rocprof           ! local radius of curvature (m)    
     rdiagbuf(30,i)         = unprof            ! geoid undulation (m)    
     rdiagbuf(31,i)         = data(iqfro,i)     ! qfro
     rdiagbuf(32,i)         = data(iascd,i)     ! ascending flag
     rdiagbuf(33,i)         = data(iazm,i)      ! azimuth angle
     rdiagbuf(34,i)         = data(iconstid,i)  ! satellite classification
     rdiagbuf(35,i)         = data(isiid,i)     ! occulting satellite 
     rdiagbuf(36,i)         = data(iogce,i)     ! Identification of processing center
     rdiagbuf(37,i)         = data(iref,i)      ! refractivity
     rdiagbuf(38,i)         = data(ihggt,i)     ! geometric height
!< xuanli -
